...
storiesOf("Appointment", module)
  ...
  .add("Empty", () => <Empty onAdd={action("Empty Add Clicked")} />)
  .add("Show", () => (
    <Show 
      onDelete={action("Show Delete Clicked")} 
      interviewer={interviewer}
      student="Puppies"
      onEdit={action("Show Edit Clicked")}
    />
  ))
  .add("Confirm", () => (
    <Confirm 
      message="Delete the appointment?"
      onCancel={action("Confrim Cancel Clicked")}
      onConfirm={action("Confirm Confirmed Clicked")}
    />
  ))
  ...
  .add("Form Edit", () => (
    <Form 
      ...
      interviewers={interviewers}
      interviewer={1}
      onCancel={action("Form Cancel Clicked")}
      onSave={action("Form Confirmed Clicked")}
    />
  ));
